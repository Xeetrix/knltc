...
import { CheckCircle2, ChevronRight, Leaf, Lock, MessageCircle, PhoneCall, ShieldCheck, Timer, UserCheck, Users, Wallet } from "lucide-react";
          ...
          <form onSubmit={submit} className="mt-8 space-y-8">
            <div className="grid gap-x-5 gap-y-5 md:grid-cols-2">
              <label className="space-y-1.5 text-sm font-medium text-slate-800">
                ...
                <Input required placeholder="নাম" className="h-12 rounded-xl border-slate-300 px-4 placeholder:text-slate-400 focus-visible:ring-2 focus-visible:ring-emerald-500/80 focus-visible:ring-offset-0 h-[52px] md:h-12" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
              </label>

              <label className="space-y-1.5 text-sm font-medium text-slate-800">
                <span className="block">মোবাইল নম্বর</span>
                <Input required placeholder="মোবাইল নম্বর" className="h-12 rounded-xl border-slate-300 px-4 placeholder:text-slate-400 focus-visible:ring-2 focus-visible:ring-emerald-500/80 focus-visible:ring-offset-0 h-[52px] md:h-12" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} />
              ...
              <label className="space-y-1.5 text-sm font-medium text-slate-800">
                ...
                <select className="h-12 w-full rounded-xl border border-slate-300 bg-white px-4 text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-emerald-500/80 focus-visible:ring-offset-0 h-[52px] md:h-12" value={form.visa_interest} onChange={(e) => setForm({ ...form, visa_interest: e.target.value as VisaInterest })}><option>Agriculture</option><option>Caregiver</option></select>
              </label>

              <label className="space-y-1.5 text-sm font-medium text-slate-800">
                <span className="block">আপনার জাপানি ভাষার লেভেল</span>
                <select className="h-12 w-full rounded-xl border border-slate-300 bg-white px-4 text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-emerald-500/80 focus-visible:ring-offset-0 h-[52px] md:h-12" value={form.japanese_level} onChange={(e) => setForm({ ...form, japanese_level: e.target.value as JapaneseLevel })}><option>N4 Passed</option><option>N5 Passed</option><option>Preparing for N4</option></select>
              </label>
              ...
              <label className="space-y-1.5 text-sm font-medium text-slate-800 md:col-span-2">
                ...
                <select className="h-12 w-full rounded-xl border border-slate-300 bg-white px-4 text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-emerald-500/80 focus-visible:ring-offset-0 h-[52px] md:h-12" value={form.skill_certificate} onChange={(e) => setForm({ ...form, skill_certificate: e.target.value as SkillCertificate })}><option>Yes</option><option>No</option></select>
              </label>
            </div>
