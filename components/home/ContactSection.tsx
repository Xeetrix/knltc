      ...
      <div className="container-narrow">
        ...
        <div className="grid gap-8 md:gap-10 lg:grid-cols-2 lg:gap-12">
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10"><MapPin className="h-5 w-5 text-primary" /></div><div><h4 className="font-bold text-foreground">{t.office}</h4><p className="break-words text-muted-foreground">{siteConfig.locations[language]}</p></div></div>
          </div>
