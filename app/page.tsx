...
export default function HomePage() {
  return <>
    ...
    <section className="section-padding"><div className="container-narrow grid gap-4 md:grid-cols-3"><Card><CardHeader><CardTitle>Work & Career in Japan</CardTitle></CardHeader><CardContent><Button asChild><Link href="/japan-career">Explore Pathway</Link></Button></CardContent></Card><Card><CardHeader><CardTitle>Study Abroad</CardTitle></CardHeader><CardContent><Button asChild><Link href="/study-abroad">Explore Pathway</Link></Button></CardContent></Card><Card><CardHeader><CardTitle>Japanese Language</CardTitle></CardHeader><CardContent><Button asChild><Link href="/japanese-language">Explore Pathway</Link></Button></CardContent></Card></div></section>
    ...
    <section className="section-padding pt-0"><div className="container-narrow rounded-2xl border bg-white p-6 text-center"><h2 className="text-3xl font-bold">Ready to choose your path?</h2><p className="mt-2 text-muted-foreground">Talk with our consultants for a structured roadmap across Japan career, language, and global education opportunities.</p><div className="mt-4 flex flex-wrap justify-center gap-3"><Button asChild><Link href="/contact">Free Consultation</Link></Button><Button asChild variant="outline"><a href="https://wa.me/8801313292295" target="_blank" rel="noopener noreferrer">WhatsApp</a></Button></div></div></section>
    <WhatsAppFAB />
  </>;
}
